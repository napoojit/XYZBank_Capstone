...
public class WithdrawalPage1 extends TestBase{
	...
	public WithdrawalPage1 Deposit(int amount)
	{
	...
	public WithdrawalPage1 Withdraw(int amount) throws InterruptedException
	{
	...
	public WithdrawalPage1 navigateToWithdrawalPage1() {
